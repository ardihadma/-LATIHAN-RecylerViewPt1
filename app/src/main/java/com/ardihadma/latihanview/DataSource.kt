...
import com.ardihadma.latihanview.models.blogPost

class DataSource{

    companion object{

        //menangkap array dari data source dan memasukkannya pada variable list
        fun createDataSet(): ArrayList<blogPost>{
            //proses memasukkan array pada variable list
